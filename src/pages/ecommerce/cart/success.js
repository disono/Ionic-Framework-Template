...
var product_list_1 = require("../product/product.list");
/**
...
var ECommerceCartSuccessPage = (function () {
  ...
  ECommerceCartSuccessPage.prototype.productList = function () {
    this.nav.setRoot(product_list_1.ECommerceProductListPage);
  };
...
exports.ECommerceCartSuccessPage = ECommerceCartSuccessPage;
