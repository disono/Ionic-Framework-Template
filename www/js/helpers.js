	...
	return {
		...
		hasConnection: function () {
			if (navigator.connection.type == Connection.NONE) {
				WBHelper.showToast('No network connection.');
		...
		showToast: function (message) {
			window.plugins.toast.show(message, 'short', 'bottom', function (a) {
